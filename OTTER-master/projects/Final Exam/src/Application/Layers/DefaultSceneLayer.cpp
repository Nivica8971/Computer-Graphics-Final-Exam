...
#pragma endregion 
		...
		Material::Sptr PlatformMaterial = ResourceManager::CreateAsset<Material>(deferredForward);
		{
			PlatformMaterial->Name = "Platform";
			PlatformMaterial->Set("u_Material.AlbedoMap", PlatformTex);
			PlatformMaterial->Set("u_Material.Shininess", 0.1f);
